        ...
        <div id="content">
          ...
          <div class="container-fluid h-100">
            ...
            <div class="card shadow mb-4 h-75">
              <div class="card-body">
                <!-- Basic Card Example -->
                <form action="#" method="post" class="h-100" id="PostEnrollForm" onsubmit="return false">
                    ...
                    <div class="card-header py-3">
                      <div class="col-sm-11 float-left">
                        <input
                          ...
                          id="postTitle"
                          class="form-control"
                          placeholder="제목 (100자 이내로 작성해주세요)"
                          maxlength="100"
                          required
                        />
                      </div>
		...
		<script>
				function submetPost()  {
				 ...
				 for (var i = 0; i < filesArr.length; i++) {
				  ...
				  let submet =  confirm("게시글을 작성 하시겠습니까?");
				  
					if(submet){
						AjaxCall('insertPost.po',"POST",formData,insertPostCallBackFnc);
						 return false;
					}
				}
				
				function insertPostCallBackFnc(callbackData){
